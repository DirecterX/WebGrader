                    ...
                    <div class="card-body " style="background-color:#EDEDED;">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                ...
                                <label style="font-size:120%; color:#<?php if(mysqli_num_rows($select_score_query) == 0){echo "FF2020";}else{if($select_score_rows['Turn_in_Status']=="passed"){echo "52DF46";}else if($select_score_rows['Turn_in_Status']=="not passed" || $select_score_rows['Turn_in_Status']=="not turn in" ){echo "FF2020";}else{echo "FFD56B";}}?>" ><?php if(mysqli_num_rows($select_score_query) == 0){echo "waiting for turn in";}else{echo $select_score_rows['Turn_in_Status'];}?></label>  <!-- Assignment Status -->
                                </p>
                            </div>
                        </div>
                        <div class="row">
