                ...
                <div class="card h-100" >
                    <div class="card-body border border-dark cardborder" style="background-color:#EDEDED;">
                        ...
                        <?php  
                            for ($i = 1; $i <= 2; $i++) {                             
                        ?>
                        <label for="Testcase<?php echo $i; ?>_Output_ex" style="margin-top: 10px;">Test Case <?php echo $i; ?>  </label> <i class="fas fa-check text-success float-right mt-2">  Passed</i>
                        ...
                        <p class="bg-warning rounded-pill rounded-5"><label class="m-2"  for="Testcase<?php echo $j; ?>_Output_ex" style="margin-top: 10px;">Hidden Case <?php echo $j; ?>  </label><i class="fas fa-times text-danger float-right mt-2 mr-2" style="font-size: larger;">  Failed</i></p>
